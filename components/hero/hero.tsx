    ...
    <section className='relative'>
      ...
      <div className='md:mt-16 flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0 lg:grid-cols-4 lg:pr-10 xl:grid-cols-12 xl:gap-0 xl:pr-0 2xl:px-96 3xl:px-[40rem]'>
        <Image
          ...
          width={1600}
          height={900}
          className='sm:min-h-[25.5rem] md:col-span-1 lg:col-span-3 lg:shrink xl:col-span-7 xl:col-start-1 '
          priority
          fetchPriority='high'
        />
        <div className="mx-auto my-auto max-w-md space-y-3 bg-transparent p-4 min-w-full md:min-w-[20rem] 3xl:min-w-[38rem]">
          <BannerStack />
        </div>
      </div>
